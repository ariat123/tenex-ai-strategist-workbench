                  ...
                  {dimensionLabels.map(([key, label]) => (
                    <label key={key} className="block">
                      ...
                      <input
                        ...
                        className="h-9 w-full rounded-md border border-slate-300 bg-white px-2 text-sm text-slate-950 outline-none transition focus:border-slate-500 focus:ring-2 focus:ring-slate-200"
                      />
                    </label>
                  ))}
                </div>
